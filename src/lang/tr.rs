...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "Durum"),
        ("Your Desktop", "Erişim Bilgileriniz"),
        ...
        ("length %min% to %max%", "Uzunluk %min% ile %max% arasında olmalıdır"),
        ("starts with a letter", "Bir harf ile başlamalı"),
        ("allowed characters", "Yanlızca harfler"),
        ...
        ("Website", "Web Sitesi"),
        ("About", "Hakkında"),
        ("Slogan_tip", "Slogan Tipi"),
        ("Privacy Statement", "Gizliki Durumu"),
        ("Mute", "Sustur"),
        ("Build Date", "Oluşturma Tarihi"),
        ("Version", "Version"),
        ("Home", "Ana Sayfa"),
        ("Audio Input", "Ses Girişi"),
        ("Enhancements", "Geliştirmeler"),
        ("Hardware Codec", "Donanımsal Hızlandırma"),
        ...
        ("Connect via relay", "Relay aracılığı ile bağlan"),
        ("Always connect via relay", "Herzaman Relay aracılığı ile bağlan"),
        ("whitelist_tip", "Bu masaüstüne yalnızca yetkili IP adresleri bağlanabilir"),
        ("Login", "Giriş yap"),
        ("Verify", "Kontrol"),
        ("Remember me", "Beni hatırla"),
        ("Trust this device", "Bu cihaza güven"),
        ("Verification code", "Onay kodu"),
        ("verification_tip", "Onya tipi"),
        ("Logout", "Çıkış yap"),
        ("Tags", "Etiketler"),
        ("Search ID", "ID Arama"),
        ...
        ("The verification code is incorrect or has expired", "Onay kodu hatalı veya süresi geçmiş"),
        ...
        ("android_start_service_tip", "Android servisi başlama tipi"),
        ("android_permission_may_not_change_tip", "Android yetkileri servis başlama tiini değiştirmeye izin vermiyor olabilir"),
        ("Account", "Hesap"),
        ...
        ("Start on boot", "Başlangıçta çalıştır"),
        ("Start the screen sharing service on boot, requires special permissions", "Ekran paylaşımı servisini başlangıçta çalıştır, özel yetki gerektirir"),
        ...
        ("Enable hardware codec", "Donanımsal hızlandırıcıları aktif et"),
        ...
        ("Automatically record outgoing sessions", "Giden oturumları otomatik olarak kayıt et"),
        ("Change", "Değiştir"),
        ...
        ("Prompt", "İstem"),
        ("Please wait for confirmation of UAC...", "Kullanıcı denetimi onayı için lütfen bekleyiniz..."),
        ...
        ("Accept sessions via password", "Oturumları parola ile kabul edin"),
        ("Accept sessions via click", "Oturumları tıklama yoluyla kabul edin"),
        ("Accept sessions via both", "Oturumları her ikisi aracılığıyla ile kabul edin"),
        ...
        ("Wait", "Bekle"),
        ("Elevation Error", "Yetki(Elevation) Hatası"),
        ...
        ("Request Elevation", "Yetki (Elevation) İsteği"),
        ("wait_accept_uac_tip", "Lütfen uzaktaki kullanıcının Windows kullanıcı denetimi (UAC) iletişim kutusunu kabul etmesini bekleyin."),
        ("Elevate successfully", "Yetki yükseltildi"),
        ...
        ("Installation failed!", "Kurulum tamamlanamadı"),
        ("Reverse mouse wheel", "Mouse tekerleğini geri çevirin"),
        ("{} sessions", "{} oturumlar"),
        ("scam_title", ""),
        ("scam_text1", ""),
        ("scam_text2", ""),
        ...
        ("I Agree", "Onaylıyorum"),
        ("Decline", "Redediyorum"),
        ("Timeout in minutes", "Zaman aşımı"),
        ("auto_disconnect_option_tip", ""),
        ("Connection failed due to inactivity", "İşlemsizlik nedeniyle bağlantı koptu"),
        ("Check for software update on startup", "Başlangıçta güncellemeleri denetle"),
        ("upgrade_rustdesk_server_pro_to_{}_tip", ""),
        ("pull_group_failed_tip", ""),
        ("Filter by intersection", "Kesişmelere göre filtrele"),
        ("Remove wallpaper during incoming sessions", "Gelen bağlantılarda masaüstü duvar kağıdını gösterme"),
        ("Test", "Test"),
        ("display_is_plugged_out_msg", ""),
        ("No displays", "Ekran yok"),
        ("Open in new window", "Yeni pencerede aç"),
        ("Show displays as individual windows", "Ekranları ayrı ekranlar olarak göster"),
        ("Use all my displays for the remote session", "Uzak bağlantılar için tüm ekranlarımı kullan"),
        ("selinux_tip", ""),
        ("Change view", "Görünümü değiştir"),
        ("Big tiles", "Büyük taşlıklar"),
        ("Small tiles", "Küçük başlıklar"),
        ("List", "Liste"),
        ("Virtual display", "Sanal ekran"),
        ("Plug out all", "Hepsini çıkar"),
        ("True color (4:4:4)", "Gerçek renkler (4:4:4)"),
        ("Enable blocking user input", "Kullanıcı girişlerini engelle"),
        ("id_input_tip", ""),
        ("privacy_mode_impl_mag_tip", ""),
        ("privacy_mode_impl_virtual_display_tip", ""),
        ("Enter privacy mode", "Gizlilik moduna geç"),
        ("Exit privacy mode", "Gizlilik modundan çık"),
        ("idd_not_support_under_win10_2004_tip", ""),
        ("input_source_1_tip", ""),
        ("input_source_2_tip", ""),
        ("Swap control-command key", "Kontrol komutlarının yerini değiştir"),
        ("swap-left-right-mouse", "Sağ-sol mouse tuşlarının yerini değiştir"),
        ("2FA code", "İki faktörlü doğrulama kodu"),
        ("More", "Daha fazla"),
        ("enable-2fa-title", ""),
        ("enable-2fa-desc", ""),
        ("wrong-2fa-code", ""),
        ("enter-2fa-title", ""),
        ("Email verification code must be 6 characters.", "Email doğrulama kodu 6 karakter olmalıdır"),
        ("2FA code must be 6 digits.", "İki faktörlü doğrulama kodu 6 karakter olmalıdır"),
        ("Multiple Windows sessions found", "Çoklu ekran oturumu bulundu"),
        ("Please select the session you want to connect to", "Lütfen bağlanmak istediğiniz oturumu seçin"),
        ("powered_by_me", ""),
        ("outgoing_only_desk_tip", ""),
        ("preset_password_warning", ""),
        ("Security Alert", "Gücenlik alarmı"),
        ...
        ("Follow remote cursor", "Uzak kullanıcı imlecini takip et"),
        ("Follow remote window focus", "Uzak kullanıcının odaklı penceresini takip et"),
        ("default_proxy_tip", ""),
        ("no_audio_input_device_tip", ""),
        ("Incoming", "Gelen"),
        ("Outgoing", "Giden"),
        ("Clear Wayland screen selection", "Clear Wayland ekran seçimi"),
        ("clear_Wayland_screen_selection_tip", ""),
        ("confirm_clear_Wayland_screen_selection_tip", ""),
        ("android_new_voice_call_tip", ""),
        ("texture_render_tip", ""),
        ("Use texture rendering", "Tekstur render kullan"),
        ("Floating window", "Yüzen pencere"),
        ("floating_window_tip", ""),
        ("Keep screen on", "Ekranı açık tut "),
        ("Never", "Asla"),
        ("During controlled", "Kontrol esnasında"),
        ("During service is on", "Servis başlatılırken"),
        ("Capture screen using DirectX", "Ekran yakalam için DirectX kullan"),
        ("Back", "Geri"),
        ("Apps", "Uygulamalar"),
        ("Volume up", "Ses arttır"),
        ...
        ("Send clipboard keystrokes", "Kopyacıya tuşları gönder"),
        ("network_error_tip", ""),
        ("Unlock with PIN", "Pin ile aç"),
        ("Requires at least {} characters", "En az {} karakter gerekli"),
        ("Wrong PIN", "Yanlış pin"),
        ("Set PIN", "Pin ayarla"),
        ("Enable trusted devices", "Güvenilir cihazları aç"),
        ("Manage trusted devices", "Güvenilir cihazları yönet"),
        ("Platform", "Platform"),
        ("Days remaining", "Kalan gün"),
        ("enable-trusted-devices-tip", ""),
        ("Parent directory", "Üst klasör"),
        ("Resume", "Devam et"),
        ("Invalid file name", "Geçersiz dosya adı"),
        ("one-way-file-transfer-tip", ""),
        ("Authentication Required", "Onaylama gerekli"),
        ("Authenticate", "Onaylama"),
        ("web_id_input_tip", ""),
        ("Download", "İndir"),
        ("Upload folder", "Yükleme klasörü"),
        ("Upload files", "Yüklenecek dosyalar"),
        ("Clipboard is synchronized", "Kopyacı senkronize"),
        ("Update client clipboard", "Müşteri kopyacısını güncelle"),
